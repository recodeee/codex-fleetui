...
case "$choice" in
  ...
  p)  # Robust paste — MIME detection, image validation, structured logging
      # all live in pane-menu-paste.sh so behavior stays identical across the
      # bash menu (here) and the tmux display-menu in style-tabs.sh.
      bash "$SCRIPT_DIR/pane-menu-paste.sh" "$PANE_ID" ;;

...
You are the `executor` role for OpenSpec plan `agent-codex-masterplan-codex-fleetui-design-match-sub-12-2026-0-2026-05-15-02-11`.
...
- `openspec/plan/agent-codex-masterplan-codex-fleetui-design-match-sub-12-2026-0-2026-05-15-02-11/executor/tasks.md`
- `openspec/plan/agent-codex-masterplan-codex-fleetui-design-match-sub-12-2026-0-2026-05-15-02-11/executor/proposal.md`

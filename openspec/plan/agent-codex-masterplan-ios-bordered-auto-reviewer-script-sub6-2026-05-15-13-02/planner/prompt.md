...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-auto-reviewer-script-sub6-2026-05-15-13-02`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-auto-reviewer-script-sub6-2026-05-15-13-02/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-auto-reviewer-script-sub6-2026-05-15-13-02/planner/proposal.md`

...
You are the `executor` role for OpenSpec plan `agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10`.
...
- `openspec/plan/agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10/executor/tasks.md`
- `openspec/plan/agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10/executor/proposal.md`

...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10`.
...
- `openspec/plan/agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-robust-paste-helper-2026-05-16-02-10/critic/proposal.md`

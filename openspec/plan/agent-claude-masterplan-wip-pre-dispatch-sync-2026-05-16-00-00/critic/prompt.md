...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00`.
...
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/critic/proposal.md`

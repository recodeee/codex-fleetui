...
You are the `executor` role for OpenSpec plan `agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00`.
...
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/executor/tasks.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/executor/proposal.md`

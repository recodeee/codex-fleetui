...
You are the `architect` role for OpenSpec plan `agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00`.
...
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/summary.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/checkpoints.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/open-questions.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/architect/tasks.md`
- `openspec/plan/agent-claude-masterplan-wip-pre-dispatch-sync-2026-05-16-00-00/architect/proposal.md`

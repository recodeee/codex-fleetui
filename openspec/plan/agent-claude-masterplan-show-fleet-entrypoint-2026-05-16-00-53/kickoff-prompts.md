...
```text
You own Wave-A for plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53` in /home/deadpool/Documents/codex-lb.

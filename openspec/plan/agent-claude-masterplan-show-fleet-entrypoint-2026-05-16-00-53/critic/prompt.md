...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53`.
...
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/critic/proposal.md`

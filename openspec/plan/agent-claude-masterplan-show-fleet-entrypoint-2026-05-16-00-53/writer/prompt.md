...
You are the `writer` role for OpenSpec plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53`.
...
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/writer/tasks.md`
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/writer/proposal.md`

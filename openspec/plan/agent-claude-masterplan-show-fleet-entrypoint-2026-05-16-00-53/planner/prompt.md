...
You are the `planner` role for OpenSpec plan `agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53`.
...
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/planner/tasks.md`
- `openspec/plan/agent-claude-masterplan-show-fleet-entrypoint-2026-05-16-00-53/planner/proposal.md`

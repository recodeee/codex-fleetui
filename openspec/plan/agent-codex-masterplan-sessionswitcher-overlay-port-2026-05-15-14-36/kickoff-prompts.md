...
```text
You own Wave-A for plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36` in /home/deadpool/Documents/codex-lb.

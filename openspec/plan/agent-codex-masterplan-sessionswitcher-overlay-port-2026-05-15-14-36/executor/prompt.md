...
You are the `executor` role for OpenSpec plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36`.
...
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/executor/tasks.md`
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/executor/proposal.md`

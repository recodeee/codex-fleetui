...
You are the `architect` role for OpenSpec plan `agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36`.
...
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/summary.md`
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/checkpoints.md`
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/open-questions.md`
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/architect/tasks.md`
- `openspec/plan/agent-codex-masterplan-sessionswitcher-overlay-port-2026-05-15-14-36/architect/proposal.md`

...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-fleet-pane-health-socket-env-2026-05-16-00-41`.
...
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-socket-env-2026-05-16-00-41/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-socket-env-2026-05-16-00-41/critic/proposal.md`

...
You are the `executor` role for OpenSpec plan `agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39`.
...
- `openspec/plan/agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39/executor/tasks.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39/executor/proposal.md`

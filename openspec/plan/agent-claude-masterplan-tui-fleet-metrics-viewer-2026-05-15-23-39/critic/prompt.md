...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39`.
...
- `openspec/plan/agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-metrics-viewer-2026-05-15-23-39/critic/proposal.md`

...
You are the `verifier` role for OpenSpec plan `agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22`.
...
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22/verifier/tasks.md`
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22/verifier/proposal.md`

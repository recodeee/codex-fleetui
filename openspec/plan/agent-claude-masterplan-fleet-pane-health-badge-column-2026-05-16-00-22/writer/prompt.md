...
You are the `writer` role for OpenSpec plan `agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22`.
...
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22/writer/tasks.md`
- `openspec/plan/agent-claude-masterplan-fleet-pane-health-badge-column-2026-05-16-00-22/writer/proposal.md`

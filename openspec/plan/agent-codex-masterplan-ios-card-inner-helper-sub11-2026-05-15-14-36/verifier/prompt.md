...
You are the `verifier` role for OpenSpec plan `agent-codex-masterplan-ios-card-inner-helper-sub11-2026-05-15-14-36`.
...
- `openspec/plan/agent-codex-masterplan-ios-card-inner-helper-sub11-2026-05-15-14-36/verifier/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-card-inner-helper-sub11-2026-05-15-14-36/verifier/proposal.md`

...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13`.
...
- `openspec/plan/agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13/planner/proposal.md`

...
You are the `critic` role for OpenSpec plan `agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13`.
...
- `openspec/plan/agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13/critic/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-pages-sub-3-2026-05-15-02-13/critic/proposal.md`

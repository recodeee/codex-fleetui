...
You are the `verifier` role for OpenSpec plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25`.
...
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/verifier/tasks.md`
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/verifier/proposal.md`

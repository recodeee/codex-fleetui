...
You are the `executor` role for OpenSpec plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25`.
...
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/executor/tasks.md`
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/executor/proposal.md`

...
```text
You own Wave-A for plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25` in /home/deadpool/Documents/codex-lb.

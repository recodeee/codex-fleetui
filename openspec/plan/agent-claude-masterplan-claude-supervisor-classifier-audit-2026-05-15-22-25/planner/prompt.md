...
You are the `planner` role for OpenSpec plan `agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25`.
...
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/planner/tasks.md`
- `openspec/plan/agent-claude-masterplan-claude-supervisor-classifier-audit-2026-05-15-22-25/planner/proposal.md`

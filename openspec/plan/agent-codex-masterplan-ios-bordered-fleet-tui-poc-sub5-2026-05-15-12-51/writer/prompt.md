...
You are the `writer` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/writer/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/writer/proposal.md`

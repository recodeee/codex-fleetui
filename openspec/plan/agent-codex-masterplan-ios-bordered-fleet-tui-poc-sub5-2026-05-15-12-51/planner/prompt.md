...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/planner/proposal.md`

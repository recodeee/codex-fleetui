...
You are the `verifier` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/verifier/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tui-poc-sub5-2026-05-15-12-51/verifier/proposal.md`

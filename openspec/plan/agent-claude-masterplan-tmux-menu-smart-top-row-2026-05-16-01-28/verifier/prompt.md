...
You are the `verifier` role for OpenSpec plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28`.
...
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/verifier/tasks.md`
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/verifier/proposal.md`

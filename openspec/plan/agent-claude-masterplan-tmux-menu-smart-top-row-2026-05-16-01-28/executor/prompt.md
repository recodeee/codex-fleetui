...
You are the `executor` role for OpenSpec plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28`.
...
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/executor/tasks.md`
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/executor/proposal.md`

...
```text
You own Wave-A for plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28` in /home/deadpool/Documents/codex-lb.

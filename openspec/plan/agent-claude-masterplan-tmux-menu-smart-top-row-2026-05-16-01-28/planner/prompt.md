...
You are the `planner` role for OpenSpec plan `agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28`.
...
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/planner/tasks.md`
- `openspec/plan/agent-claude-masterplan-tmux-menu-smart-top-row-2026-05-16-01-28/planner/proposal.md`

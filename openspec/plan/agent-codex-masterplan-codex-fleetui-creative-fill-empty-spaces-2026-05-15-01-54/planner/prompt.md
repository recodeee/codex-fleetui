...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54`.
...
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/planner/proposal.md`

...
You are the `executor` role for OpenSpec plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54`.
...
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/executor/tasks.md`
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/executor/proposal.md`

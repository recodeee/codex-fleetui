...
```text
You own Wave-A for plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54` in /home/deadpool/Documents/codex-lb.

...
You are the `critic` role for OpenSpec plan `agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54`.
...
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/critic/tasks.md`
- `openspec/plan/agent-codex-masterplan-codex-fleetui-creative-fill-empty-spaces-2026-05-15-01-54/critic/proposal.md`

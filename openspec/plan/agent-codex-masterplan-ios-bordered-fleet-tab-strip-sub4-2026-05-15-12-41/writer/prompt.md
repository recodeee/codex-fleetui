...
You are the `writer` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/writer/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/writer/proposal.md`

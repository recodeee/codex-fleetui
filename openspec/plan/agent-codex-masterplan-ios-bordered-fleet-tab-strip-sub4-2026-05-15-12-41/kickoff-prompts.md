...
```text
You own Wave-A for plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41` in /home/deadpool/Documents/codex-lb.

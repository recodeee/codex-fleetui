...
You are the `executor` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/executor/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/executor/proposal.md`

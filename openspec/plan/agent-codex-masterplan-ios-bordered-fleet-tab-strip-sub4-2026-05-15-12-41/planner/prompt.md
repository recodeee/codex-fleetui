...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-fleet-tab-strip-sub4-2026-05-15-12-41/planner/proposal.md`

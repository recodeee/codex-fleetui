...
You are the `architect` role for OpenSpec plan `agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03`.
...
- `openspec/plan/agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03/summary.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03/checkpoints.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03/open-questions.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03/architect/tasks.md`
- `openspec/plan/agent-codex-masterplan-ios-bordered-context-menu-sub-12-2026-05-15-02-03/architect/proposal.md`

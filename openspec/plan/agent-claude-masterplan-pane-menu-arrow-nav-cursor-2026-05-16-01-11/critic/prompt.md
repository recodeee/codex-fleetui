...
You are the `critic` role for OpenSpec plan `agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11`.
...
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/critic/tasks.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/critic/proposal.md`

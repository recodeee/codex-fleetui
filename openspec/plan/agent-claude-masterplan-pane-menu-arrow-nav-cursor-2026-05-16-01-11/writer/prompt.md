...
You are the `writer` role for OpenSpec plan `agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11`.
...
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/writer/tasks.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/writer/proposal.md`

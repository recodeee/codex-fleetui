...
You are the `architect` role for OpenSpec plan `agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11`.
...
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/summary.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/checkpoints.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/open-questions.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/architect/tasks.md`
- `openspec/plan/agent-claude-masterplan-pane-menu-arrow-nav-cursor-2026-05-16-01-11/architect/proposal.md`

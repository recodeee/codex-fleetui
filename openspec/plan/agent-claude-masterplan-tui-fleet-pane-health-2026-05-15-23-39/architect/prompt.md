...
You are the `architect` role for OpenSpec plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39`.
...
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/summary.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/checkpoints.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/open-questions.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/architect/tasks.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/architect/proposal.md`

...
You are the `planner` role for OpenSpec plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39`.
...
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/planner/tasks.md`
- `openspec/plan/agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39/planner/proposal.md`

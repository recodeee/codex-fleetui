...
```text
You own Wave-A for plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-B for plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39` in /home/deadpool/Documents/codex-lb.
...
```text
You own Wave-C for plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39` in /home/deadpool/Documents/codex-lb.
...
```text
You are the integrator for plan `agent-claude-masterplan-tui-fleet-pane-health-2026-05-15-23-39` in /home/deadpool/Documents/codex-lb.
